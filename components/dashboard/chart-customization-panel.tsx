...
export function ChartCustomizationPanel({
  ...
  // Merged dataMapping: merge configDataMapping (AI-generated) with customization (user overrides)
  // CRITICAL FIX: Properly merge both objects instead of using OR operator
  // The OR operator would prevent configDataMapping from being used if customization.dataMapping is {}
  const effectiveDataMapping = React.useMemo(() => {
    // Start with configDataMapping (AI-generated baseline)
    const mapping = {
      ...configDataMapping,
      // Overlay user customizations on top
    ...
    console.log('🔍 [CUSTOMIZATION_PANEL] effectiveDataMapping:', {
      ...
      hasConfigMapping: !!configDataMapping && Object.keys(configDataMapping).length > 0,
      hasCustomMapping: !!customization?.dataMapping && Object.keys(customization.dataMapping).length > 0
    })
    return mapping
  }, [customization?.dataMapping, configDataMapping, effectiveChartType])

  // Helper function to convert schema type to InlineFilter compatible type
                              ...
                              <div className="flex items-center justify-between p-2 bg-blue-100 border border-blue-300 rounded">
                                ...
                                <div className="flex items-center gap-1">
                                  <InlineFilter
                                    ...
                                    columnType={getInlineFilterColumnType(effectiveDataMapping.xAxis || effectiveDataMapping.category)}
                                    data={data || rawData || []}
                          ...
                          {(effectiveChartType === 'combo' || effectiveChartType === 'bar' || effectiveChartType === 'line' || effectiveChartType === 'area' || effectiveChartType === 'scatter') ? (
                            <>
                              ...
                              >
                                ...
                                {(() => {
                                  // Support multiple field names: yAxis1, yAxis, or values (AI may use any)
                                  const leftAxisData = effectiveDataMapping?.yAxis1 || effectiveDataMapping?.yAxis || effectiveDataMapping?.values
                                      ...
                                      {(Array.isArray(leftAxisData) ? leftAxisData : [leftAxisData]).map((field: string) => (
                                        <div key={field} className="flex items-center justify-between p-2 bg-green-100 border border-green-300 rounded">
                                          ...
                                          <div className="flex items-center gap-1">
                                            <InlineFilter
                                              column={field}
                                              columnType={getInlineFilterColumnType(field)}
                                              data={data || rawData || []}
                                              filters={customization?.filters}
                                              onFiltersChange={(filters) => {
                                                onCustomizationChange(chartId, { filters })
                                      ...
                                      <div className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-1">
                                          <InlineFilter
                                            ...
                                            columnType={getInlineFilterColumnType(effectiveDataMapping.size)}
                                            data={data || rawData || []}
                                            filters={customization?.filters}
                                            onFiltersChange={(filters) => {
                                              onCustomizationChange(chartId, { filters })
                                      ...
                                      <div className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-1">
                                          <InlineFilter
                                            ...
                                            columnType={getInlineFilterColumnType(effectiveDataMapping.color)}
                                            data={data || rawData || []}
                                            filters={customization?.filters}
                                            onFiltersChange={(filters) => {
                                              onCustomizationChange(chartId, { filters })
                              ...
                              <div className="flex items-center justify-between p-2 bg-purple-100 border border-purple-300 rounded">
                                ...
                                <div className="flex items-center gap-1">
                                  <InlineFilter
                                    ...
                                    columnType={getInlineFilterColumnType(effectiveDataMapping.category)}
                                    data={data || rawData || []}
                                    filters={customization?.filters}
                                    onFiltersChange={(filters) => {
                                      onCustomizationChange(chartId, { filters })
                              ...
                              <div className="flex items-center justify-between p-2 bg-orange-100 border border-orange-300 rounded">
                                ...
                                <div className="flex items-center gap-1">
                                  <InlineFilter
                                    ...
                                    columnType={getInlineFilterColumnType(effectiveDataMapping.value)}
                                    data={data || rawData || []}
                                    filters={customization?.filters}
                                    onFiltersChange={(filters) => {
                                      onCustomizationChange(chartId, { filters })
                              ...
                              <div className="flex items-center justify-between p-2 bg-indigo-100 border border-indigo-300 rounded">
                                ...
                                <div className="flex items-center gap-1">
                                  <InlineFilter
                                    ...
                                    columnType={getInlineFilterColumnType(effectiveDataMapping.metric)}
                                    data={data || rawData || []}
                                    filters={customization?.filters}
                                    onFiltersChange={(filters) => {
                                      onCustomizationChange(chartId, { filters })
                                ...
                                <div className="flex items-center justify-between">
                                  ...
                                  <div className="flex items-center gap-1">
                                    <InlineFilter
                                      ...
                                      columnType={getInlineFilterColumnType(effectiveDataMapping.type)}
                                      data={data || rawData || []}
                                      filters={customization?.filters}
                                      onFiltersChange={(filters) => {
                                        onCustomizationChange(chartId, { filters })
                                ...
                                <div className="flex items-center justify-between">
                                  ...
                                  <div className="flex items-center gap-1">
                                    <InlineFilter
                                      ...
                                      columnType={getInlineFilterColumnType(effectiveDataMapping.xAxis)}
                                      data={data || rawData || []}
                                      filters={customization?.filters}
                                      onFiltersChange={(filters) => {
                                        onCustomizationChange(chartId, { filters })
                                ...
                                <div className="flex items-center justify-between">
                                  ...
                                  <div className="flex items-center gap-1">
                                    <InlineFilter
                                      ...
                                      columnType={getInlineFilterColumnType(effectiveDataMapping.yAxis)}
                                      data={data || rawData || []}
                                      filters={customization?.filters}
                                      onFiltersChange={(filters) => {
                                        onCustomizationChange(chartId, { filters })
                                ...
                                <div className="flex items-center justify-between">
                                  ...
                                  <div className="flex items-center gap-1">
                                    <InlineFilter
                                      ...
                                      columnType={getInlineFilterColumnType(effectiveDataMapping.cohort)}
                                      data={data || rawData || []}
                                      filters={customization?.filters}
                                      onFiltersChange={(filters) => {
                                        onCustomizationChange(chartId, { filters })
                                ...
                                <div className="flex items-center justify-between">
                                  ...
                                  <div className="flex items-center gap-1">
                                    <InlineFilter
                                      ...
                                      columnType={getInlineFilterColumnType(effectiveDataMapping.period)}
                                      data={data || rawData || []}
                                      filters={customization?.filters}
                                      onFiltersChange={(filters) => {
                                        onCustomizationChange(chartId, { filters })
                                ...
                                <div className="flex items-center justify-between">
                                  ...
                                  <div className="flex items-center gap-1">
                                    <InlineFilter
                                      ...
                                      columnType={getInlineFilterColumnType(effectiveDataMapping.actual)}
                                      data={data || rawData || []}
                                      filters={customization?.filters}
                                      onFiltersChange={(filters) => {
                                        onCustomizationChange(chartId, { filters })
                                ...
                                <div className="flex items-center justify-between">
                                  ...
                                  <div className="flex items-center gap-1">
                                    <InlineFilter
                                      ...
                                      columnType={getInlineFilterColumnType(effectiveDataMapping.comparative)}
                                      data={data || rawData || []}
                                      filters={customization?.filters}
                                      onFiltersChange={(filters) => {
                                        onCustomizationChange(chartId, { filters })
