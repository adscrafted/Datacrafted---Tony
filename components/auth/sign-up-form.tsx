  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-semibold text-[#1f1f1f] mb-2" style={{ fontFamily: "'Google Sans Text', Helvetica, Arial, sans-serif" }}>
          Create your account
        </h2>
        <p className="text-sm text-[#5f6368]" style={{ fontFamily: "Helvetica, Arial, sans-serif" }}>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            disabled={loading}
          />
          <p className="mt-1 text-xs text-[#5f6368]">Must be at least 6 characters</p>
        </div>
      ...
      <button
        ...
        disabled={loading}
        className="w-full py-3 px-4 border border-gray-300 hover:border-gray-400 bg-white text-[#1f1f1f] font-medium rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
      >
