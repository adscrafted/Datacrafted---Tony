...
export interface ChartRecommendation {
  ...
  type: 'scorecard' | 'bar' | 'line' | 'pie' | 'area' | 'scatter' | 'table' | 'combo' | 'waterfall' | 'heatmap' | 'gauge' | 'cohort' | 'bullet' | 'treemap' | 'sparkline';
...
export interface EnhancedAnalysisResult {
  ...
  chartConfig: Array<{
    id?: string
    type: 'line' | 'bar' | 'pie' | 'area' | 'scatter' | 'scorecard' | 'table' | 'combo' | 'waterfall' | 'heatmap' | 'gauge' | 'cohort' | 'bullet' | 'treemap' | 'sparkline'
    title: string
    description: string
    dataMapping?: {
      category?: string
